 ...
 * @author zineb
 */
public class MyRendererAndEditorbijoux implements TableCellRenderer, TableCellEditor {
   JButton btn;
   JButton btn2;
   int row;
  public MyRendererAndEditorbijoux(JTable table) {
    ...
    btn.addActionListener(new ActionListener() {
      ...
      public void actionPerformed(ActionEvent e) {
          try {
              ...
              Logger.getLogger(MyRendererAndEditorbijoux.class.getName()).log(Level.SEVERE, null, ex);
          }
      }
    });
  }
