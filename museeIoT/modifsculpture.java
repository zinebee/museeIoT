...
public class modifsculpture implements TableCellRenderer, TableCellEditor {
   ...
   JButton btn2;
   int row;
  public modifsculpture(JTable table) {
    ...
    btn.addActionListener(new ActionListener() {
      ...
      public void actionPerformed(ActionEvent e) {
         ...
         // f1.add(ii2);
          ...
          submit.addActionListener(new ddfsculpture(i1,submit,table));
          //  model.addRow(data);
...
class ddfsculpture implements ActionListener{
JTextField i1;
JTextField i2;
JButton submit;
JTable table;
public ddfsculpture(JTextField i1,JButton submit,JTable table){
 this.i1=i1;
//this.i2=i2;
this.table=table;
this.submit=submit;
    ...
    public void actionPerformed(ActionEvent ae) {
      if(ae.getSource()==this.submit){
          int gg=table.getSelectedRow();
           CRUD_SCULPTURE hj=new CRUD_SCULPTURE();
