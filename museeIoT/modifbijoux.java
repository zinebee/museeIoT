 ...
 * @author zineb
 */
public class modifbijoux implements TableCellRenderer, TableCellEditor {
   JButton btn;
   JButton btn2;
   int row;
  public modifbijoux(JTable table) {
    ...
    btn.addActionListener(new ActionListener() {
      ...
      public void actionPerformed(ActionEvent e) {
         ...
         // f1.add(ii2);
          ...
          submit.addActionListener(new ddfbijoux(i1,submit,table));
          //  model.addRow(data);
...
class ddfbijoux implements ActionListener{
JTextField i1;
JTextField i2;
JButton submit;
JTable table;
public ddfbijoux(JTextField i1,JButton submit,JTable table){
 this.i1=i1;
//this.i2=i2;
this.table=table;
this.submit=submit;
    ...
    public void actionPerformed(ActionEvent ae) {
      if(ae.getSource()==this.submit){
          int gg=table.getSelectedRow();
           CRUD_BIJOUX hj=new CRUD_BIJOUX();
