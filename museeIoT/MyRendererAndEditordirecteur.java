 ...
 * @author zineb
 */
public class MyRendererAndEditordirecteur implements TableCellRenderer, TableCellEditor {
   JButton btn;
   JButton btn2;
   int row;
  public MyRendererAndEditordirecteur(JTable table) {
...
//              int ddD=(int)table.getValueAt(row, 0);
              ...
              CRUD_DIRECTEUR hh=new CRUD_DIRECTEUR();
