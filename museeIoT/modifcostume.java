 ...
 * @author zineb
 */
public class modifcostume implements TableCellRenderer, TableCellEditor {
   JButton btn;
   JButton btn2;
   int row;
  public modifcostume(JTable table) {
    ...
    btn.addActionListener(new ActionListener() {
      ...
      public void actionPerformed(ActionEvent e) {
         ...
         // f1.add(ii2);
          ...
          submit.addActionListener(new ddfcostume(i1,submit,table));
          //  model.addRow(data);
...
class ddfcostume implements ActionListener{
JTextField i1;
JTextField i2;
JButton submit;
JTable table;
public ddfcostume(JTextField i1,JButton submit,JTable table){
 this.i1=i1;
//this.i2=i2;
this.table=table;
this.submit=submit;
    ...
    public void actionPerformed(ActionEvent ae) {
      if(ae.getSource()==this.submit){
          int gg=table.getSelectedRow();
           CRUD_COSTUME hj=new CRUD_COSTUME();
          ...
          if(u==1){
           table.setValueAt(this.i1.getText(),gg,2);
          }
