 ...
 * @author zineb
 */
public class modif implements TableCellRenderer, TableCellEditor {
   JButton btn;
   JButton btn2;
   int row;
  public modif(JTable table) {
    ...
    btn.addActionListener(new ActionListener() {
      ...
      public void actionPerformed(ActionEvent e) {
         ...
         // f1.add(ii2);
          ...
          submit.addActionListener(new ddf(i1,submit,table));
          //  model.addRow(data);
...
class ddf implements ActionListener{
JTextField i1;
JTextField i2;
JButton submit;
JTable table;
public ddf(JTextField i1,JButton submit,JTable table){
 this.i1=i1;
//this.i2=i2;
this.table=table;
this.submit=submit;
    ...
    public void actionPerformed(ActionEvent ae) {
      if(ae.getSource()==this.submit){
          int gg=table.getSelectedRow();
           CRUD_TABLEAU hj=new CRUD_TABLEAU();
