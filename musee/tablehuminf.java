 ...
 * @author zineb
 */
public class tablehuminf extends DefaultTableCellRenderer {
    ...
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
        ...
        if (column == 0) {
           ...
           Object o = table.getValueAt(row, 1);
            ...
            if(ff!=null){
            if(!ff.isEmpty()){
//            int convertir=Integer.parseInt(ff);
            
            Color clrA = new Color(253, 63, 1);
            ...
            if(column==1){
        Color clrX = new Color(37, 253, 233);
