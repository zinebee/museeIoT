 ...
 * @author zineb
 */
public class Tableaud extends JFrame implements ActionListener,TableModelListener,WindowListener,InternalFrameListener{
  private static double frameCountY=-0.5;
  static String marche="oui";
/* Permet de décaler les fenêtres horizonalement */
private static double frameCountX=2;
  JButton button;
  JButton button2;
  JButton button3;
  JButton button4;
  ...
  hmitableau k1=new hmitableau(Color.red);
  inftableau k2=new inftableau(Color.blue);
  ...
  String titre;
    ...
    Object[][] jI;
    JScrollPane stable;
    public Tableaud(String titre, String Description, double c1,String c2){
     this.titre=titre;
   ...
   public Tableaud(String[][] donne){
      ...
      table.getColumn("Supprimer").setCellRenderer(new MyRendererAndEditor(table));
    table.getColumn("Supprimer").setCellEditor(new MyRendererAndEditor(table));
    table.getColumn("Modifier").setCellRenderer(new modif(table));
    table.getColumn("Modifier").setCellEditor(new modif(table));
      stable=new JScrollPane(table);
      
      button2=new JButton("supprimer");
      button3=new JButton("Desactiver les noifications");
     ...
     // p1.add(button3);
      ...
      k1=new hmitableau(hj);
      k2=new inftableau(hj);
      //essai
        ...
        try {
          ...
          public void actionPerformed(ActionEvent ae){
           if(ae.getSource()==button5){
               System.out.println("tout est desactiver");
               r.interrupt();
               r1.interrupt();
            ...
            String[] ress=product.gettit();
            //pro
             Socket sockett = new Socket("127.0.0.1", 3004);
...
public String getC2(){
  return this.c2;
    ...
    /*  JTextField i2=new JTextField();
      ...
      JTextField i1=new JTextField(String.valueOf(b));
      String ii2="fg";
        if(ae.getActionCommand().equals("Ajouter Tableau")){
      JFrame k=new JFrame();
     ...
     // y.addActionListener(new formulaire(i2.getText()));
      k.pack();
      k.add(y);
      k.setVisible(true);
      ...
      k.setLocationRelativeTo(null);
        ...
        if(ae.getActionCommand().equals("inserer")){
         System.out.println("vous appuyez sur le bouton inserer du formualire" +ii2);
       }*/
    
     if(ae.getActionCommand().equals("Ajouter Tableau")){
       this.n=new formulaire("tableau",this);
       //System.out.println("cccc"+n.getoui());
     }
...
public String[] ee(String[] ff,int d){
  String[] f=ff;
  int l=ff.length;
  for(int y=d;y<l;y++){
      int t=y+1;
  ...
  return f;
    ...
    public void windowOpened(WindowEvent we) {
     ...
     Thread g=new Thread(new servtableau());
      g.start();
      Thread g5=new Thread(new servtableaupro());
      g5.start();
    ...
    public void windowActivated(WindowEvent we) {
      /*int i=0;
        CRUD_TABLEAU tab=new CRUD_TABLEAU();
        jI=tab.mofi(this.jI,i);
        i++;
        CRUD_TABLEAU nz=new CRUD_TABLEAU();
